...
.navbar__item:nth-child(1)::before {
  content: "";
  position: absolute;
  display: block;
  left: -7rem;
...
.main__btn {
  ...
  border: none;
  background-color: #9976fb;
  box-shadow: 0 0.25rem 0.5rem rgba(153, 118, 251, 0.25);
  cursor: pointer;
}
    ...
    <main class="main">
      <div class="main__left">
        ...
        <p class="main__typography">
          ...
          future where everyone lives up to their own dream.
        </p>
